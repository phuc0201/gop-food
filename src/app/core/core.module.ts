...
@NgModule({
  ...
  imports: [
    CommonModule,
    ScrollDirective,
    StoreModule.forRoot({ auth_login: loginReducer, get_profile: getProfileReducer, get_restaurant_list: getRestaurantListReducer, get_restaurant_info: getRestaurantInfoReducer, get_menu: getMenuReducer, getFoodDetails: getFoodDetailsReducer }),
